...
class ArduinoFirebaseBridge:
    def __init__(self, serial_port='COM13', baud_rate=9600, firebase_cred_path='D:\leanhtu\landslide-7cf2a-firebase-adminsdk-6s2n2-6573c60bb0.json', database_url='https://landslide-7cf2a-default-rtdb.firebaseio.com/'):
        try:
