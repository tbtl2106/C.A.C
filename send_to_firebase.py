...
class ArduinoFirebaseBridge:
    def __init__(self, serial_port='/dev/ttyACM0', baud_rate=9600, firebase_cred_path='/home/pi/Downloads/landslide-7cf2a-firebase-adminsdk-6s2n2-865edd57d6.json', database_url='https://landslide-7cf2a-default-rtdb.firebaseio.com/'):
        try:
    ...
    def read_arduino_data(self):
        if self.ser.in_waiting:
            try:
                ...
                print(f"Error parsing Arduino data: {str(e)}")
                return None
        return None
    ...
    def upload_to_firebase(self, data):
        try:
            ...
            # FOR ESP32
            ref = db.reference(f'sensor_data/{current_date}*/sensor 1')
...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        'baud_rate': 9600,
        'firebase_cred_path': '/home/pi/Downloads/landslide-7cf2a-firebase-adminsdk-6s2n2-865edd57d6.json',
